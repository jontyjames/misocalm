...
export default function ExperienceRow() {
  ...
  }, []); // eslint-disable-line react-hooks/exhaustive-deps -- day-of-year stable within session

  return (
    <section>
      <SectionHeading glowColor="rgba(139,92,246,0.3)">Experiences</SectionHeading>
      <ScrollRow>
        {remaining.map((exp) => {
              ...
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <p
                    ...
                    style={{ marginBottom: PHI_SCALE[0] }}
                  >
                    {exp.description}
                  </p>
                  <span
